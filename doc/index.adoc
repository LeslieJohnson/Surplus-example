...
By http://les-johnson.com[Leslie Johnson]

Surplus offers a faster, simpler approach to Reactive web app
development than React.
...
language selection for all menus and text across the app. This document
is best read while looking at the http://stleocenterville.org[live app.]
...
Surplus components look like the pure functional components in React and
Inferno. JSX is a standard separate from React which Surplus follows.
...
to demonstrate S and Surplus, and have a public-facing open source app
as an example of my work. It’s a successor to a previous version I wrote
using AngularJS, and I started this version’s development using React,
then Inferno, then Surplus.
...
should help if you prefer Windows for development.
